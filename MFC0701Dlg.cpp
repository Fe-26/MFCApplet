...
CMFC0701Dlg::CMFC0701Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFC0701_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMFC0701Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_EDIT1, Edit);
}

BEGIN_MESSAGE_MAP(CMFC0701Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMFC0701Dlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CMFC0701Dlg::OnBnClickedButton2)
	ON_BN_CLICKED(IDC_BUTTON3, &CMFC0701Dlg::OnBnClickedButton3)
END_MESSAGE_MAP()


// CMFC0701Dlg 消息处理程序

BOOL CMFC0701Dlg::OnInitDialog()
{
...
void CMFC0701Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMFC0701Dlg::OnQueryDragIcon()
{
